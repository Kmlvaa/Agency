        ...
        <div className="flex flex-col mt-10 items-center px-5 max-lg:mt-6">
            ...
            <div className="my-20 grid grid-cols-4 justify-between gap-4 max-md:grid-cols-2">
                {services?.map((service) => {
                    return (
                        <div className="homePageCard group flex flex-col items-center py-5 px-4 w-auto rounded-lg hover:bg-MainOrange hover:text-white">
                            ...
                            <div className='w-20 h-20 rounded-full bg-MainOrange group-hover:bg-white'>
