...
export default function about() {
    return (
        <div className='bg-foreground w-screen h-auto p-20 absolute top-10 -left-[650px] rounded-b-3xl flex-col z-50 hidden group-hover:flex transition ease delay-500'>
