...
export default function page() {
    ...
    return (
        <div>
            <div className='flex flex-col items-start px-28 gap-10 mt-20 max-lg:px-5 max-sm:items-center'>
                <h1 className='font-bold text-5xl mb-20'>Xidmətlərimiz</h1>
                <div className='grid grid-cols-3 items-center gap-10 max-sm:!grid-cols-1'>
                    {cards?.map((card) => {
                        return (
                            <div key={card.id} className='group bg-foreground border border-gray-200 rounded-2xl flex flex-col gap-5 max-sm:items-center max-sm:flex-row items-start px-5 py-8 shadow-[inset_0px_-1px_19px_0px_rgba(0,_0,_0,_0.1)] hover:bg-MainOrange hover:text-white'
                            onClick={() => setModalShow(true)}>
                                <div className='bg-white rounded-full !w-16 !h-16 p-3 mb-3 max-sm:p-1'>
                                    <Image src={Icon} alt='icon' className='w-full h-full object-contain'/>         
                                </div>
                                <div className='w-auto'>
                                    <h1 className='font-semibold text-2xl my-4'>{card.name}</h1>
                                ...
                                <div className='flex flex-row gap-2 text-center items-center text-gray-800 mt-10 cursor-pointer group-hover:text-white max-sm:!hidden'>
                ...
                <div className='my-10 m-auto'>
                    ...
                    <div className='flex flex-row gap-5 mt-32'>
                        <div className='flex flex-col items-center justify-between border border-gray-300 rounded-2xl p-6 shadow-[-1px_5px_8px_0px_rgba(0,_0,_0,_0.1)]'>
                        ...
                        <div className='flex flex-col items-center justify-between border !border-MainOrange relative -top-20 rounded-2xl p-6 shadow-[-1px_5px_8px_0px_rgba(0,_0,_0,_0.1)]'>
                ...
                <div className='my-10 m-auto'>
                    ...
                    <div className='flex flex-row items-center justify-center max-lg:flex-wrap gap-5 mt-32'>
                        ...
                        <div className='flex flex-col items-center justify-between border !border-MainOrange relative -top-20 max-lg:top-0 rounded-2xl p-6 shadow-[-1px_5px_8px_0px_rgba(0,_0,_0,_0.1)]'>
                            <Image src={VideoIcon2} width={150} height={150} alt='econom' />
                            <p className='text-gray-700 font-bold text-3xl'>1100 m</p>
                            <h1 className='font-bold text-4xl'>Standart</h1>
                            <ol className='text-gray-800 my-5'>
