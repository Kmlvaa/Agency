    ...
    return (
        <div className='pt-20 text-gray-900'>
            ...
            <div className='my-28 mx-0 flex flex-col items-center gap-20'>
                ...
                <div className='flex flex-row gap-5 items-center justify-between px-0'>
                    <div className='w-2/4 pl-28 max-lg:pl-5'>
                ...
                <div className='flex flex-row gap-5 items-center text-end justify-between'>
                    <div className='w-2/4'>
                        <Image src={dizayn} alt='smm'/>
                    </div>
                    <div className='w-2/4 pr-28 max-lg:pr-5'>
                ...
                <div className='flex flex-row gap-5 items-center text-start justify-between px-0'>
                    <div className='w-2/4 pl-28 max-lg:pl-5'>
