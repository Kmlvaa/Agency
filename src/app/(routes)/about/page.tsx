    ...
    return (
        <div className='pt-10 text-gray-900'>
            ...
            <div className='my-28 mx-0 flex flex-col items-center gap-20'>
                ...
                <div className='flex flex-row gap-5 items-center justify-between px-0 max-sm:flex-col-reverse'>
                ...
                <div className='flex flex-row gap-5 items-center text-end justify-between max-sm:flex-col max-sm:text-start'>
                    <div className='w-2/4 max-sm:w-full max-sm:px-5'>
                ...
                <div className='flex flex-row gap-5 items-center text-start justify-between px-0 max-sm:flex-col-reverse'>
                    <div className='w-2/4 pl-28 max-lg:pl-5 max-sm:w-full'>
